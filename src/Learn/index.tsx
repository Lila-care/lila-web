...
import PhaseSection from "@/Learn/PhaseSection";

// Colores duplicados intencionalmente de src/lib/phaseInfo.ts (mismo criterio documentado ahí:
// "usado en Today, Calendar y Learn") — mantené ambos en sync si cambia una rampa de fase.
const PHASES = [
  {
    dayRange: "Días 1–5",
  ...
  return (
    <AppShell>
      <div className="px-6 md:px-16 pt-14 pb-6">
        ...
        >
          Tu ciclo no es lineal — cada fase trae su propia energía. Conocerlas
          te ayuda a moverte con tu cuerpo, no contra él.
        </p>
      </div>
